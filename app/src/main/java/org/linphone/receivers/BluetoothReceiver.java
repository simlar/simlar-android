...
public class BluetoothReceiver extends BroadcastReceiver {
    ...
    public interface Listener {
        ...
        void bluetoothHeadetConnectionChanged(boolean b);
        void bluetoothHeadetAudioConnectionChanged(boolean b);
        void bluetoothHeadetScoConnectionChanged(boolean b);
    }

    public BluetoothReceiver(final Listener listener) {
        super();
        Lg.i("[Bluetooth] Bluetooth receiver created");
        mListener = listener;
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
            ...
            if (state == BluetoothHeadset.STATE_CONNECTED) {
                ...
                mListener.bluetoothHeadetConnectionChanged(true);
            } else if (state == BluetoothHeadset.STATE_DISCONNECTED) {
                Lg.i("[Bluetooth] Bluetooth headset disconnected");
                mListener.bluetoothHeadetConnectionChanged(false);
            } else {
            ...
            if (state == BluetoothHeadset.STATE_AUDIO_CONNECTED) {
                ...
                mListener.bluetoothHeadetAudioConnectionChanged(true);
            } else if (state == BluetoothHeadset.STATE_AUDIO_DISCONNECTED) {
                Lg.i("[Bluetooth] Bluetooth headset audio disconnected");
                mListener.bluetoothHeadetAudioConnectionChanged(false);
            ...
            if (state == AudioManager.SCO_AUDIO_STATE_CONNECTED) {
                ...
                mListener.bluetoothHeadetScoConnectionChanged(true);
            } else if (state == AudioManager.SCO_AUDIO_STATE_DISCONNECTED) {
                Lg.i("[Bluetooth] Bluetooth headset SCO disconnected");
                mListener.bluetoothHeadetScoConnectionChanged(false);
